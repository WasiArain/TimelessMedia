/*!/wp-content/plugins/designthemes-fb-pixel/script.js*/
(function() {
    var fbq = (function() {
        function fbq() {
            if (arguments.length > 0) {
                ...
                var params = [];
                if (typeof action == "string" && action.replace(/\s+/gi, "") != "" && typeof pixel_id == "string" && pixel_id.replace(/\s+/gi, "") != "" && typeof type_track == "string" && type_track.replace(/\s+/gi, "")) {
